<template>
  <div
    class="relative z-0 flex min-h-screen w-full flex-col items-center justify-center overflow-hidden rounded-md bg-black"
  >
    <div
    ...
    >
      ...
      >
        <div
          class="absolute bottom-0 left-0 z-20 h-40 w-[100%] bg-black [mask-image:linear-gradient(to_top,white,transparent)]"
        />
        <div
          class="absolute bottom-0 left-0 z-20 h-[100%] w-40 bg-black [mask-image:linear-gradient(to_right,white,transparent)]"
        />
      </div>
      <div
      ...
      >
        <div
          class="absolute bottom-0 right-0 z-20 h-[100%] w-40 bg-black [mask-image:linear-gradient(to_left,white,transparent)]"
        />
        <div
          class="absolute bottom-0 right-0 z-20 h-40 w-[100%] bg-black [mask-image:linear-gradient(to_top,white,transparent)]"
        />
      </div>
      <div
