<template>
  ...
  >
    ...
    >
      <div
        class="group/card h-[15rem] w-[20rem] rounded-xl border border-black/[0.1] bg-gray-50 p-6 [transform-style:preserve-3d] dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] [&>*]:[transform-style:preserve-3d]"
      >
        <p
